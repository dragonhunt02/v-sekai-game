...
Some files are provided in parts as **split zip** archives (.zip .z01 .z02...). To **extract them** download all same name parts, move them to a folder and extract the .zip file with software like **7-zip**.
