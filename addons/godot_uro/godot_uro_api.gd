...
func get_profile_async() -> Dictionary:
	...
	var profile_path = godot_uro.new_api? godot_uro_helper_const.NEW_PROFILE_PATH : godot_uro_helper_const.PROFILE_PATH
...
func sign_in_async(p_username_or_email: String, p_password: String) -> Dictionary:
	...
	var signin_path = godot_uro.new_api? godot_uro_helper_const.NEW_LOGIN_PATH : godot_uro_helper_const.SESSION_PATH
